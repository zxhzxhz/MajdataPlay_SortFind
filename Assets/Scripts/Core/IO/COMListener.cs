    ...
    public static partial class InputManager
    {
        static void StartUpdatingTouchPanelState()
        {
            ...
            _serialPortUpdateTask = Task.Factory.StartNew(() =>
            {
                ...
                var comPort = $"COM{MajEnv.UserSetting.Misc.InputDevice.TouchPanel.COMPort}";
                var stopwatch = new Stopwatch();
                var t1 = stopwatch.Elapsed;
                using var serial = new SerialPort(comPort, MajEnv.UserSetting.Misc.InputDevice.TouchPanel.BaudRate);
