...
{
    internal class TouchPanelRenderer: MajComponent
    {
        public IReadOnlyDictionary<int, int> InstanceID2SensorIndexMappingTable
        {
            get => _instanceID2SensorIndexMappingTable;
        }
        ...
        {
            Majdata<TouchPanelRenderer>.Instance = this;
            base.Awake();
        ...
        static bool IsSensorRendererEnabled()
        {
            return MajInstances.Setting.Debug.DisplaySensor;
        }
