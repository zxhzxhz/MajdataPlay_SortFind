...
namespace MajdataPlay.Title
{
    public class TitleManager : MonoBehaviour
    {
        ...
        async UniTaskVoid DelayPlayVoice()
        {
            ...
            AudioManager.PlaySFX("MajdataPlay.wav");
            AudioManager.PlaySFX("bgm_title.mp3");
        }
        ...
        void EnterTestMode()
        {
            ...
            _flag = false;
            AudioManager.StopSFX("bgm_title.mp3");
            AudioManager.StopSFX("MajdataPlay.wav");
