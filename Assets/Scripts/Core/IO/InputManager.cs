...
{
    public static unsafe partial class InputManager
    {
        ...
        static InputManager()
        {
            _isSensorRendererEnabled = MajEnv.UserSetting.Debug.DisplaySensor;
            _isBtnDebounceEnabled = MajEnv.UserSetting.Misc.InputDevice.ButtonRing.Debounce;
            _isSensorDebounceEnabled = MajEnv.UserSetting.Misc.InputDevice.TouchPanel.Debounce;
            _btnDebounceThresholdMs = TimeSpan.FromMilliseconds(MajEnv.UserSetting.Misc.InputDevice.ButtonRing.DebounceThresholdMs);
            _btnPollingRateMs = TimeSpan.FromMilliseconds(MajEnv.UserSetting.Misc.InputDevice.ButtonRing.PollingRateMs);
            _sensorDebounceThresholdMs = TimeSpan.FromMilliseconds(MajEnv.UserSetting.Misc.InputDevice.TouchPanel.DebounceThresholdMs);
            _sensorPollingRateMs = TimeSpan.FromMilliseconds(MajEnv.UserSetting.Misc.InputDevice.TouchPanel.PollingRateMs);
            _cameraProviderRef = new ReadOnlyRef<IMainCameraProvider?>(ref Majdata<IMainCameraProvider>.Instance);
            switch (MajEnv.UserSetting.Misc.InputDevice.ButtonRing.Type)
            {
        ...
        static void StartExternalIOManager()
        {
            ...
            var useHID = MajEnv.UserSetting.Misc.InputDevice.ButtonRing.Type is DeviceType.HID;
            ...
            try
            {
                ...
                var btnDebounce = MajEnv.UserSetting.Misc.InputDevice.ButtonRing.Debounce;
                var touchPanelDebounce = MajEnv.UserSetting.Misc.InputDevice.TouchPanel.Debounce;

                var btnProductId = MajEnv.UserSetting.Misc.InputDevice.ButtonRing.ProductId;
                var btnVendorId = MajEnv.UserSetting.Misc.InputDevice.ButtonRing.VendorId;
                var comPortNum = MajEnv.UserSetting.Misc.InputDevice.TouchPanel.COMPort;

                var btnPollingRate = MajEnv.UserSetting.Misc.InputDevice.ButtonRing.PollingRateMs;
                //var btnDebounceThresholdMs = btnDebounce ? MajEnv.UserSetting.Misc.InputDevice.ButtonRing.DebounceThresholdMs : 0;
                var btnDebounceThresholdMs = 0;

                var touchPanelPollingRate = MajEnv.UserSetting.Misc.InputDevice.TouchPanel.PollingRateMs;
                //var touchPanelDebounceThresholdMs = touchPanelDebounce ? MajEnv.UserSetting.Misc.InputDevice.TouchPanel.DebounceThresholdMs : 0;
                ...
                var touchPanelConnProperties = new Dictionary<string, dynamic>()
                {
                    ...
                    { "BaudRate", MajEnv.UserSetting.Misc.InputDevice.TouchPanel.BaudRate },
                    { "SensitivityOverride", true },
                    { "Sensitivity", MajEnv.UserSetting.Misc.InputDevice.TouchPanel.Sensitivity }
                };
                var ledConnProperties = new Dictionary<string, dynamic>()
                {
                    { "ComPortNumber", $"COM{MajEnv.UserSetting.Misc.OutputDevice.Led.COMPort}" },
                    { "BaudRate", MajEnv.UserSetting.Misc.OutputDevice.Led.BaudRate }
                };
